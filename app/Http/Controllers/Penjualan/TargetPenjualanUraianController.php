...
class TargetPenjualanUraianController extends Controller
{
    ...
    {
        try {
            $data = TargetPenjualanUraian::all();
    ...
    {
        try {
            $data = TargetPenjualanUraian::findOrFail($id);
    ...
    public function store(Request $request)
    {
        ...
        try {
            $validator = Validator::make($request->all(), [
                'nama' => 'required|unique:target_penjualan_uraian,nama',
            ]);
            ...
            $data = TargetPenjualanUraian::create($request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $validator = Validator::make($request->all(), [
                'nama' => 'required|unique:target_penjualan_uraian,nama,' . $id,
            ]);
            ...
            $data = TargetPenjualanUraian::find($id);
