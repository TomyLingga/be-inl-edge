...
use App\Http\Controllers\LevyReutersViewer;
...
class LevyDutyController extends Controller
{
    ...
    public function __construct(LevyReutersViewer $levyReutersViewer)
    {
        parent::__construct();

        $this->levyReutersViewer = $levyReutersViewer;
    }
    ...
    {
        try {
            $data = LevyDuty::with('product', 'mataUang')->get();
    ...
    {
        try {
            $data = LevyDuty::with('product', 'mataUang')->findOrFail($id);
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $existingEntry = LevyDuty::where('id_bulky', $request->id_bulky)
            ...
            $data = LevyDuty::create($request->all());
    ...
    public function indexPeriod(Request $request)
    {
        ...
        try {
            ...
            $data = $this->levyReutersViewer->indexPeriodLevyDuty($tanggalAwal, $tanggalAkhir, $idMataUang);
