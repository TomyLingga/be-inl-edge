    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $dataToUpdate = [
                ...
                'kontak' => $request->filled('kontak') ? $request->kontak : $data->kontak,
                'negara' => $request->filled('negara') ? $request->negara : $data->negara,
                'provinsi' => $request->filled('provinsi') ? $request->provinsi : $data->provinsi,
                'kota' => $request->filled('kota') ? $request->kota : $data->kota,
                'alamat' => $request->filled('alamat') ? $request->alamat : $data->alamat,
            ];
