...
class MasterCostController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            ...
            $data = MasterCost::create($request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $dataToUpdate = [
                ...
                'contribute_to_margin' => $request->filled('contribute_to_margin') ? $request->contribute_to_margin : $data->contribute_to_margin
            ];
