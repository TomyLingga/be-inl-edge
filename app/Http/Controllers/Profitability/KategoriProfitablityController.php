...
class KategoriProfitablityController extends Controller
{
    ...
    {
        try {
            $data = KategoriProfitablity::findOrFail($id);
    ...
    public function store(Request $request)
    {
        ...
        try {
            $validator = Validator::make($request->all(), [
                'name' => 'required|unique:kategori_profitablity,name',
            ]);
            ...
            $data = KategoriProfitablity::create($request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $data = KategoriProfitablity::find($id);
