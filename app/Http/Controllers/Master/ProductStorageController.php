...
class ProductStorageController extends Controller
{
    ...
    {
        try {
            $data = ProductStorage::with('lokasi')->findOrFail($id);
    ...
    {
        try {
            $data = ProductStorage::with('lokasi')->where('jenis',$jenis)->get();
    ...
    public function store(Request $request)
    {
        ...
        try {
            $validator = Validator::make($request->all(), [
                'name' => 'required|unique:product_storage,name',
                'id_lokasi' => 'required|exists:' . Lokasi::class . ',id',
                'jenis' => 'required|in:tanki,warehouse',
            ...
            $data = ProductStorage::create($request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            $validator = Validator::make($request->all(), [
                'name' => 'required|unique:product_storage,name,' . $id,
                'id_lokasi' => 'required|exists:' . Lokasi::class . ',id',
                'jenis' => 'required|in:tanki,warehouse',
                'kapasitas' => 'required|numeric'
            ]);
