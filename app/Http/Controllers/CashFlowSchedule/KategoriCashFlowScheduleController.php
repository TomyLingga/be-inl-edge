...
class KategoriCashFlowScheduleController extends Controller
{
    ...
    {
        try {
            $data = KategoriCashFlowSchedule::findOrFail($id);
    ...
    public function store(Request $request)
    {
        ...
        try {
            $validator = Validator::make($request->all(), [
                'name' => 'required|unique:kategori_cash_flow_schedule,name',
            ]);
            ...
            $data = KategoriCashFlowSchedule::create($request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $data = KategoriCashFlowSchedule::find($id);
