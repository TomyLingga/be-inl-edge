...
class UraianSdmController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $validator = Validator::make($request->all(), [
                'name' => 'required|unique:uraian_sdm,name',
            ]);
            ...
            $data = UraianSdm::create($request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $validator = Validator::make($request->all(), [
                'name' => 'required|unique:uraian_sdm,name,' . $id,
            ]);
