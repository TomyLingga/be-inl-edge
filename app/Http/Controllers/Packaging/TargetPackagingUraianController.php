...
class TargetPackagingUraianController extends Controller
{
    ...
    {
        try {
            $data = TargetPackagingUraian::all();
    ...
    {
        try {
            $data = TargetPackagingUraian::findOrFail($id);
    ...
    public function store(Request $request)
    {
        ...
        try {
            $validator = Validator::make($request->all(), [
                'nama' => 'required|unique:target_packaging_uraian,nama',
            ]);
            ...
            $data = TargetPackagingUraian::create($request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $validator = Validator::make($request->all(), [
                'nama' => 'required|unique:target_packaging_uraian,nama,' . $id,
            ]);
            ...
            $data = TargetPackagingUraian::find($id);
