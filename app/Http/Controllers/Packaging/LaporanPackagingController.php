...
use App\Models\Packaging\ItemPackaging;
...
class LaporanPackagingController extends Controller
{
    ...
    public function store(Request $request)
    {
        ...
        try {
            $rules = [
                'item_packaging_id' => 'required|exists:' . ItemPackaging::class . ',id',
            ...
            $existingEntry = LaporanPackaging::where('item_packaging_id', $request->item_packaging_id)
            ...
            $data = LaporanPackaging::create($request->all());
    ...
    public function update(Request $request, $id)
    {
        ...
        try {
            ...
            $data = LaporanPackaging::findOrFail($id);
    ...
    public function indexPeriod(Request $request)
    {
        ...
        try {
            ...
            $data = $this->packagingViewer->indexPeriodLaporanPackaging($tanggalAwal, $tanggalAkhir, $idPackaging);
